...
def add_args(parser):
    ...
    parser.add_argument('--config_file', required=False,
                        default="/home/sun/Lne/lnemamba-main/configs/train_configs/intra/BH-rPPG-Bright_HRManmba.yaml", type=str, help="The name of the model.")
    return parser
...
def train_and_test(config, data_loader_dict):
    ...
    elif config.MODEL.NAME == 'HRMamba':
        model_trainer = trainer.HRMambaFormerTrainer.HRMambaFormerTrainer(config, data_loader_dict)
    elif config.MODEL.NAME == 'rPPGMamba':
        model_trainer = trainer.rPPGMambaFormerTrainer.rPPGMambaFormerTrainer(config, data_loader_dict)
    else:
...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "BH-rPPG":
            train_loader = data_loader.BHrPPGLoader.BHrPPGLoader
        else:
        ...
        elif config.VALID.DATA.DATASET == "BH-rPPG":
            valid_loader = data_loader.BHrPPGLoader.BHrPPGLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TEST.DATA.DATASET == "BH-rPPG":
            test_loader = data_loader.BHrPPGLoader.BHrPPGLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), and UBFC-PHYS.")
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "BH-rPPG":
            unsupervised_loader = data_loader.BHrPPGLoader.BHrPPGLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
